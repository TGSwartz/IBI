...
setwd("/Users/Tom/Documents/IBI/evi/")
...
dates <- c("2009.12.20,", "2010.01.10") # set dates to all of 2011
...
Download <- function(dates) {
  ModisDownload(x = product ,h = horiz,v = vert,dates = dates,
                ...
                proj_type = "UTM",utm_zone = "36S",datum = "WGS84", pixel_size = 1000) #463.3127)
}
